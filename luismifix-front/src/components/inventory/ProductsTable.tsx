...
export function ProductsTable({ onEditProduct, onEditLinks }: { onEditProduct?: (product: Product) => void | undefined, onEditLinks?: (product: Product) => void | undefined }) {
    ...
    const alwaysShowColumns = ['Nombre', 'Unidades disponibles', 'Editar']
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                        {table
                            ...
                            .map((column) => {
                                if (alwaysShowColumns.includes(column.id)) return;
                                return (
                                    <DropdownMenuCheckboxItem
                                        key={column.id}
